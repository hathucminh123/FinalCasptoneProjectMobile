...
type LoginScreenRouteProp = RouteProp<
  ...
  "params"
>;
const LoginEmployerScreen = ({ navigation, route }: any) => {
  ...
  const {
    ...
    onSuccess: async (data) => {
      try {
        ...
        if (userRole) storageItems.push(["role", userRole]);
        ...
        if (userRole === "employer") {
          navigation.navigate(CompanyId !== "null" ? "Employer" : "CreateCompany");
        }
      } catch (e) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.logoText}>Amazing Job For Employer</Text>
